...
import { getDashboardSnapshot, getWaitlistEntries } from "@/lib/data";
    ...
    <div className="space-y-6">
      ...
      <section className="space-y-2">
        ...
        <p className="max-w-3xl text-sm leading-7 text-foreground/65">
          Join our waitlist. We&apos;ll follow up with a personalized demo and next steps.
        </p>
        <div className="pt-2">
          <Link
            href="/staff"
            className="inline-flex items-center justify-center rounded-2xl border border-line bg-white px-4 py-2.5 text-sm font-semibold text-foreground hover:border-accent hover:text-accent"
          >
            Try It Out
          </Link>
        </div>
